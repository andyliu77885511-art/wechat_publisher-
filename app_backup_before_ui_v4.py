...
/* ====================================================================
   公众号定位选择器 v5（紧凑 chip 横排 — emoji + 名称完整显示）
   ==================================================================== */

/* 整个 radio 区域的容器标签隐藏 */
div[data-testid="stRadio"][aria-label="公众号定位"] > label {
    display: none !important;
}

/* radio 选项列表 → 横向 flex wrap */
div[data-testid="stRadio"][aria-label="公众号定位"] > div {
...
/* 每个 chip */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label {
...
/* 隐藏 radio 原始圆点 */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label > div:first-child {
    display: none !important;
}

/* chip 内文字容器 */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label > div:last-child {
    display: flex !important;
...
/* chip 内文字 */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label > div:last-child p {
    margin: 0 !important;
    font-size: 0.85rem !important;
...
/* hover 态 */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label:hover {
...
/* 选中态 */
div[data-testid="stRadio"][aria-label="公众号定位"] > div > label:has(input:checked) {
...
# 格式：「emoji 名称  描述」，通过 _POS_NAMES 匹配名称
